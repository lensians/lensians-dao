...
const supportedChainURLs = {
  ...
  [ChainId_Amoy]: createNetworkHttpUrl('polygon-amoy'),
};
...
export const Amoy: Chain = {
  ...
  getExplorerAddressLink: (address: string) => `https://amoy.polygonscan.com/address/${address}`,
  getExplorerTransactionLink: (transactionHash: string) =>
...
const useDappConfig = {
  ...
  networks: [...DEFAULT_SUPPORTED_CHAINS, Sepolia, Amoy],
};
...
const BLOCKS_PER_DAY = 600; // 10 mins for test

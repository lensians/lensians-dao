...
export const ChainId_Amoy = 80002;
...
const app: Record<SupportedChains, AppConfig> = {
  ...
  [ChainId_Amoy]: {
    jsonRpcUri: createNetworkHttpUrl('polygon-amoy'),
    wsRpcUri: createNetworkWsUrl('polygon-amoy'),
    subgraphApiUri:
      'https://api.studio.thegraph.com/query/82571/lensians/v0.1.0',
    enableHistory: process.env.REACT_APP_ENABLE_HISTORY === 'true',
  },
  [ChainId.Mainnet]: {
